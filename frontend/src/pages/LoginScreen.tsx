      ...
      <div className="grid grid-cols-3 gap-3 w-full max-w-[280px]">
        {["1", "2", "3", "4", "5", "6", "7", "8", "9"].map((digit) => (
          <button
            ...
            className="btn-press w-full aspect-square rounded-2xl bg-card text-foreground text-heading font-bold flex items-center justify-center border border-border hover:bg-muted transition-colors min-h-[64px]"
